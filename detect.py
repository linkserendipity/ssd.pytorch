...
parser.add_argument('--weights', default='E:\ssd.pytorch-master/weights/ssd300_COCO_25000.pth',
                    type=str, help='Trained state_dict file path')
parser.add_argument('--cuda', default=False, type=bool,
                    help='Use cuda in live demo')
parser.add_argument('--save_dir', type=str, default='E:\ssd.pytorch-master/tmp4',
...
if __name__ == '__main__':
    ...
    image_path = 'E:\ssd.pytorch-master/video_calorie'
